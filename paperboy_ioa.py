...
RECIPIENT = 'Mark Hurn <{0}@ast.cam.ac.uk>'.format('hurnm') #to ellude spam bots

# Example usage:    python paperboy_ioa.py           (to run previous month)
#                   python paperboy_ioa.py 2015 8    (to run for August, 2015)
